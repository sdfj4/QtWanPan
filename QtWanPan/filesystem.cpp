    ...
    : QWidget{parent}
{
    ...
    QVBoxLayout *pDirOpVBL = new QVBoxLayout;
    ...
    QVBoxLayout *pFileOpVBL = new QVBoxLayout;
    ...
    QHBoxLayout *pMainVBL = new QHBoxLayout;
...
void FileSystem::createDir()
{
    ...
    if(!strDirName.isEmpty())
    {
        ...
        {
            QMessageBox::warning(this,"警告","文件夹名太长");
        }else{
        ...
        QMessageBox::warning(this,"警告","创建文件夹失败");
    }
